    ...
    <div class="main-grid">
      ...
      <div>
        ...
        <template v-if="article.articleContent">
          ...
          <el-button @click="visible = true" class="reward">
                    打赏
                </el-button>
                <el-dialog v-model="visible" :show-close="false" >
                  ...
                  <img v-if="websiteConfig.weiXinQRCode"  :src="websiteConfig.weiXinQRCode" />
                  <img v-else  :src="default" />
                  <img v-if="websiteConfig.alipayQRCode"  :src="websiteConfig.alipayQRCode" />
                  <img v-else  :src="default" />
                </el-dialog> 
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      ...
      default: 'https://static.wusuowei.online/img/SB9P0M%606L%7EF%29%28%7BZC2H_D5%60N.png',
      handleAuthorClick,
      loading,
      t
    }
...
.reward{
  ...
  // //bottom: 40%;
   ...
   background-color: rgb(223, 138, 224);
